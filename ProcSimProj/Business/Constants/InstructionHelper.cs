...
namespace ProcSimProj.Business.Constants
{
    ...
    {
        public static Regex RegexIndexed => new Regex("([(]R\\d[)])");

        public static Regex RegexIndirect => new Regex("(R\\d)");

        public static List<InstructionCodeBo> GetInstructionCode() => new List<InstructionCodeBo>
        {
